      ...
      <main className="flex w-full h-full flex-col gap-[32px] row-start-2 items-center sm:items-start">
        <Waves>
          <section id="hero" className="flex flex-col items-center justify-center text-center gap-8">
            <div id="heading"  className="flex flex-col gap-8 text-8xl ">
              <h1 className="invisible">feelFreeVPN VPN app & service</h1>
              <span className="mr-60">FEEL FREE</span>
              <span className="">DURING</span>
              <span className="ml-60">YOUR FLY</span>
            </div>
            <Link href="/install" >
              <button
              className="border-2 w-[500px] flex justify-center border-[#0c344d] px-6 py-4 text-lg rounded hover:bg-[#0c344d] hover:text-white transition-colors duration-200 cursor-pointer"
            >
        ...
        <section>
          <h2 className="invisible mt-32">Features</h2>
